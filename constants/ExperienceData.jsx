export const ExperienceData = [
  {
    companyName: "INFINITY-UP",
    location: "Dover, DE, United States",
    role: "Senior Unity Engineer",
    fromTo: "May 2020 - Present",
    description:
      "Project flexibility to speed up the process and split the work between teams. Remake a game with Unity technology, push it to the limits with visuals and physics that are possible in multiplayer, and get the new battle royale mode.",
    side: "left",
  },
  {
    companyName: "The NineHertz",
